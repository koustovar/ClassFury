            ...
            child: Scaffold(
              appBar: AppBar(
                title: Text(
                  'Student Details',
                  style:
                      AppTypography.headline6.copyWith(color: AppColors.white),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        label: 'Student Name',
                        validator: (v) =>
                            AppValidators.validateRequired(v, 'Student Name'),
                      ),
                      const Gap(16),
                      CustomTextField(
                        ...
                        label: 'Guardian Name',
                        validator: (v) =>
                            AppValidators.validateRequired(v, 'Guardian Name'),
                      ),
                      const Gap(16),
                      CustomTextField(
                      ...
                      CustomTextField(
                        ...
                        label: 'Class',
                        validator: (v) =>
                            AppValidators.validateRequired(v, 'Class'),
                      ),
                      const Gap(16),
                      CustomTextField(
