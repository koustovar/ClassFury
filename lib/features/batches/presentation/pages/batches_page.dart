              ...
              return RefreshIndicator(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (itemContext, index) {
                    ...
                    return _BatchCard(batch: batch as BatchModel);
                  },
                ),
              );
            }
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            ...
            if (result == true) {
              if (context.mounted) {
                final authState = getIt<AuthBloc>().state;
                final tId = authState is AuthAuthenticated ? authState.user.uid : '';
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.groups_outlined, size: 80, color: Theme.of(context).hintColor),
            const Gap(24),
            Text('No Batches Found', style: Theme.of(context).textTheme.displaySmall),
            const Gap(12),
            Text(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Gap(4),
                  Text(batch.subject, style: AppTypography.bodySmall.copyWith(color: color, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
            Column(
              ...
              children: [
                Row(
                  ...
                  const Gap(4),
                  Text('${batch.studentCount}', style: Theme.of(context).textTheme.bodySmall),
                  ],
                ),
                const Gap(8),
                Container(
