  ...
  void _onCreate(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      ...
      getIt<BatchesCubit>().createBatch(
        ...
        tuitionFees: int.parse(_tuitionController.text.trim()),
      );
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomTextField(
                        ...
                        validator: (v) =>
                            AppValidators.validateRequired(v, 'Batch Name'),
                      ),
                      ...
                      CustomTextField(
                        label: 'Tuition Fees',
                        hint: 'Enter tuition amount',
                        controller: _tuitionController,
                        keyboardType: TextInputType.number,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Tuition Fees is required';
                          }
                          final parsed = int.tryParse(value);
                          if (parsed == null || parsed < 0) {
                            return 'Please enter a valid tuition amount';
                          }
                          return null;
                        },
                      ),
