        ...
        listener: (context, state) {
          if (state is BatchRequestSent) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Join request sent! Waiting for teacher approval.'))
            );
                ...
                body: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.vignette_outlined, size: 80, color: AppColors.primary),
                        const Gap(24),
                        ...
                        const Gap(32),
                        CustomButton(label: 'Join Batch', onPressed: () => _onJoin(builderContext)),
                      ],
                    ),
                  ),
                ),
